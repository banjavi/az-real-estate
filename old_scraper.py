...
def main():
    ...
    # setup the scraper with the zip database and enable multiprocessing
    ...
    # break down the zip codes into chunks of 5 zip codes at a time to avoid corruption 
    chunk_size = 5
    for i in range(0, len(zip_codes), chunk_size):
        zip_chunk = zip_codes[i:i+chunk_size]
        
        # activate the scraper for the given zip codes chunk
